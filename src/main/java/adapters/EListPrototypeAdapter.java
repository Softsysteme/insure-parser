...
public class EListPrototypeAdapter extends XmlAdapter<AdaptedPrototypeEList, EList<IPrototype>> implements InternalEObject {
    ...
    public EList<IPrototype> unmarshal(AdaptedPrototypeEList v) throws Exception {
        EList<IPrototype> protList = new EObjectContainmentEList<IPrototype>(IPrototype.class, this, ICorePackage.REPOSITORY__PROTOTYPES);
        // for (Object prot : v.getPrototypes()) {
        // if (prot instanceof StandardFeldelementeigenschaften) {
        // for (Object obj : v.getPrototypes()) {
        // if (obj instanceof StandardFeldelementeigenschaften) {
        // ((StandardFeldelementeigenschaften) obj).setStandardEingabeelementeigenschaft((Eingabeelementeigenschaft) prot);
        // v.getPrototypes().remove(prot);
        // System.out.println("removed: " + prot.getClass());
        // }
        //
        // }
        // }
        // if (prot instanceof Steuerelementeigenschaft) {
        // for (Object obj : v.getPrototypes()) {
        // if (obj instanceof StandardFeldelementeigenschaften) {
        // ((StandardFeldelementeigenschaften) obj).setStandardSteuerelementeigenschaft((Steuerelementeigenschaft) prot);
        // v.getPrototypes().remove(prot);
        // System.out.println("removed: " + prot.getClass());
        // }
        //
